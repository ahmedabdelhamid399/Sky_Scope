package com.iti.skyscope.broadcastreceiver
...
onReceive() method: This method is called when the BroadcastReceiver receives an Intent broadcast.
It checks if a listener is registered and if so, it calls the onNetworkConnectionChanged() method of that listener
with a boolean value indicating whether the network is connected or not.
